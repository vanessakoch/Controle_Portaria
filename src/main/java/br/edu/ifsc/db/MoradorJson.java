...
public class MoradorJson implements MoradorDBInterface {
	...
	public ObservableList<Morador> getMoradores() {
		if (moradores == null) {
			...
			moradores.add(new Morador("Pedro da Silva", "00000014503", "15/10/1992", "2535559898", 140, "4B", 5,
					"10/10/2018", false));
			moradores.add(new Morador("Joao da Silva", "11111111111", "15/10/1970", "4725548789", 101, "1A", 1,
					"10/01/2017", true));
